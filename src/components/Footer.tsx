        ...
        <div className="relative max-w-4xl mx-auto px-5 md:px-8">
          <div className="relative p-8 md:p-12 rounded-2xl bg-gradient-to-br from-card via-card to-muted/10 border border-honey/20 shadow-lg overflow-hidden">
            ...
            <div className="relative text-center">
              ...
              {/* Microcopy */}
              <p className="text-sm text-muted-foreground/70">We reply within 24–48 hours. For quick answers, DM us.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-5 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
            ...
            <div className="lg:col-span-1">
              <h3 className="font-serif text-2xl font-bold text-foreground mb-4">BuzzCraftCreatives</h3>
            ...
            {/* Column 2 - Services */}
            <div>
              <h4 className="text-xs font-semibold text-muted-foreground uppercase tracking-widest mb-5">Services</h4>
            ...
            {/* Column 3 - Contact */}
            <div>
              <h4 className="text-xs font-semibold text-muted-foreground uppercase tracking-widest mb-5">Contact</h4>
              <div className="space-y-4">
                ...
                <p className="text-xs text-muted-foreground/60 mt-3">DMs welcome for faster replies.</p>
              </div>
            </div>
