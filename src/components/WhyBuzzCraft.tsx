  ...
  return (
    <section className="py-28 md:py-36 lg:py-44 bg-lavender/5 overflow-hidden">
      <div className="container-narrow mx-auto px-5 md:px-8">
        ...
        <div className="lg:hidden flex flex-col items-center gap-12 animate-fade-up" style={{ animationDelay: "0.2s" }}>
        ...
        <div
          className="mt-24 md:mt-32 text-center animate-fade-up"
